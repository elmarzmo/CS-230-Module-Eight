...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		final GameUserRESTController gameUserRESTController = new GameUserRESTController(e.getValidator());
        e.jersey().register(gameUserRESTController);
       ...
       final Client client = new JerseyClientBuilder(e)
        ...
        final RESTClientController restClientController = new RESTClientController(client);
        e.jersey().register(restClientController);
